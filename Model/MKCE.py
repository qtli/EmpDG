...
class MK_Enc(nn.Module):
    ...
    def save_model(self, running_avg_ppl, iter, f1_g,f1_b,ent_g,ent_b):
        ...
        model_save_path = os.path.join(self.model_dir, 'model_{}_{:.4f}_{:.4f}_{:.4f}'.format(iter,running_avg_ppl,f1_g,f1_b) )
    ...
    def train_one_batch(self, batch, iter, train=True):
        ...
        pre_logit, attn_dist = self.decoder(dec_emb, encoder_outputs, (mask_src,mask_trg))
    ...
    def decoder_greedy(self, batch, max_dec_step=30):
        ...
        for i in range(max_dec_step+1):
            if config.project:
                ...
                out, attn_dist = self.decoder(ys_emb, encoder_outputs, (mask_src,mask_trg))
