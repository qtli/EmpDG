...
def load_dataset():
    if os.path.exists('empathetic-dialogue/my_dataset_preproc.p'):
        print("LOADING empathetic_dialogue")
        with open('empathetic-dialogue/my_dataset_preproc.p', "rb") as f:
    ...
    #     data_tra, data_val, data_tst, vocab = read_langs(vocab=Lang({config.UNK_idx: "UNK", config.PAD_idx: "PAD", config.EOS_idx: "EOS", config.SOS_idx: "SOS", config.USR_idx:"USR", config.SYS_idx:"SYS", config.CLS_idx:"CLS", config.ROOT_idx:"ROOT"))
...
#     print("Building dataset...")  # train: 40250; valid: 5734; test: 5255.
#     data_tra, data_val, data_tst, vocab = read_langs(vocab=Lang({config.UNK_idx: "UNK", config.PAD_idx: "PAD", config.EOS_idx: "EOS", config.SOS_idx: "SOS", config.USR_idx:"USR", config.SYS_idx:"SYS", config.CLS_idx:"CLS", config.ROOT_idx:"ROOT"}))
#     with open('empathetic-dialogue/KED_dataset_preproc.p', "wb") as f:
#         pickle.dump([data_tra, data_val, data_tst, vocab], f)
#         print("Saved PICKLE")
